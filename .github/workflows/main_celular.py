...
class CoffeeSimulator(BoxLayout):
    ...
    def __init__(self, **kwargs):
        ...
        # Cargar sonidos
        self.coffee_sound = self.load_sound("coffe_sound.mp3")
        self.sugar_sound = self.load_sound("suggar_sound.mp3")
        
        # Cargar imágenes (en Kivy usamos rutas directas)
        self.coffee_machine_image = "image.png"
        self.milk_image = "añadir_leche.png"
        self.sugar_image = "añadir_azucar.png"
        
        # Diccionario de imágenes de café preparado
        self.coffee_images = {
            "Espresso": "cafe_espresso.png",
            "Cappuccino": "cafe_cappuccino.png",
            "Latte": "cafe_latte.png",
            "Americano": "cafe_americano.png",
            "Mocha": "cafe_mocha.png"
        }
